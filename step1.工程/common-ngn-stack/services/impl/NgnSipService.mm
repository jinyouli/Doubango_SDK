...
#warning 挂断会崩溃 出现野指针问题
                    ...
                    NSLog(@"Terminated   Audio/Video/MSRP(Chat, FileTransfer)");
//                    isInComing = false;
...
//    SipStack * stack = [sipStack getStack];
//    stack->setDisplayName(stringAsChar);
//    
//    const char * impuChars = [sipPreferences.impu cStringUsingEncoding:[NSString defaultCStringEncoding]];
